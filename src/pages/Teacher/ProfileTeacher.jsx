      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-[#4C53B4] mb-2 flex items-center gap-2">
                <i className="fa-solid fa-user-circle text-[#4C53B4]"></i>
                Profile Settings
              </h1>
              <p className="text-[#4C53B4] text-sm sm:text-base">Manage your personal information</p>
            </div>
            {!isEditing && (
              <button
